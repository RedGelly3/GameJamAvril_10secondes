...
public class PlayerScript : MonoBehaviour
{
    ...
    {   
        ...
        gameObject.GetComponent<CapsuleCollider2D>().size = newTransformation.GetComponent<CapsuleCollider2D>().size;
        gameObject.GetComponent<CapsuleCollider2D>().offset = newTransformation.GetComponent<CapsuleCollider2D>().size;
